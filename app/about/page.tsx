...
export default function AboutPage() {
    return (
        <div className="min-h-screen pt-32 pb-20 bg-white subtle-grain">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <section className="relative h-[70vh] flex items-center justify-center overflow-hidden mb-24 rounded-none border border-black/5 shadow-2xl">
                    <div className="absolute inset-0 bg-forge-bone z-0"></div>
                    ...
                    <div className="relative z-20 text-center space-y-8 max-w-5xl px-4">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-3 px-6 py-2.5 bg-forge-red/10 border border-forge-red/20"
                        >
                            <Sparkles size={18} className="text-forge-red" />
                            <span className="text-[10px] text-forge-red font-black tracking-[0.4em] uppercase">Forging a Legacy</span>
                        </motion.div>
                        <motion.h1
                            initial={{ opacity: 0, y: 30 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            WE ARE <br /> <span className="text-forge-red">FORGE</span> SHOP
                        </motion.h1>
                        <motion.p
                            initial={{ opacity: 0, y: 30 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.2 }}
                            className="text-forge-grey text-xl md:text-2xl font-light italic bg-white/50 backdrop-blur-sm inline-block px-4"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-48">
                    ...
                    >
                        <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tighter text-black leading-[0.9]">The Blacksmith&apos;s <br /> <span className="text-forge-red">Journey</span></h2>
                        ...
                        <div className="flex flex-wrap gap-10 pt-8 border-t border-black/5">
                            <div className="flex items-center gap-4">
                                <div className="p-4 bg-forge-red text-white shadow-lg shadow-forge-red/20">
                                    <Hammer size={24} />
                                </div>
                                <div>
                                    <p className="text-black font-black text-sm uppercase tracking-widest">Engineering</p>
                                    <p className="text-forge-grey text-[10px] font-bold uppercase tracking-widest">Heavyweight standard</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="p-4 bg-black text-white shadow-lg shadow-black/20">
                                    <ShieldCheck size={24} />
                                </div>
                                <div>
                                    <p className="text-black font-black text-sm uppercase tracking-widest">Mindset</p>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="aspect-square bg-forge-bone border border-black/5 overflow-hidden relative shadow-2xl flex items-center justify-center p-16 group"
                    >
                        <div className="absolute inset-0 subtle-grain opacity-50"></div>
                        <div className="relative z-10 text-center space-y-8">
                            <div className="text-9xl md:text-[12rem] font-black text-black/5 italic group-hover:text-forge-red/10 transition-luxury">FP</div>
                            <p className="text-black/40 font-black text-xs uppercase tracking-[0.6em]">EST. 2024 • MUMBAI</p>
                        </div>
                    </motion.div>
                </div>

                {/* Cultural Context Section */}
                <section className="mb-48 bg-forge-bone p-16 md:p-32 border border-black/5 shadow-inner">
                    <motion.div
                        initial={{ opacity: 0, y: 30 }}
                    ...
                    >
                        <span className="text-xs font-black tracking-[0.5em] text-forge-red uppercase">Evolution</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="p-12 bg-white border border-black/5 hover:border-forge-red/30 transition-luxury group shadow-sm hover:shadow-xl"
                            >
                                <h3 className="text-black font-black text-2xl tracking-tighter mb-4 group-hover:text-forge-red transition-colors uppercase">{item.title}</h3>
                                <div className="text-[10px] text-forge-red uppercase tracking-[0.3em] mb-6 font-black">{item.origin}</div>
                ...
                <section className="relative p-12 md:p-32 bg-black overflow-hidden text-center space-y-12 mb-20">
                    <div className="absolute inset-0 bg-gradient-to-br from-forge-red/20 to-transparent pointer-events-none"></div>
                    <Heart size={64} className="text-forge-red mx-auto opacity-80 animate-pulse" />
                    <h2 className="text-4xl md:text-7xl font-black text-white uppercase tracking-tighter max-w-5xl mx-auto leading-[0.85]">
                        FORGE A MINDSET, <br /> <span className="text-forge-red">CLAIM YOUR PIECE.</span>
                    </h2>
                    <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="bg-forge-red text-white px-16 py-6 text-sm font-black tracking-[0.4em] uppercase shadow-2xl shadow-forge-red/40 hover:bg-forge-red-hover transition-luxury"
                    >
                        View Collection
                    </motion.button>
                </section>

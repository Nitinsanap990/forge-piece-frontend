                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
                    ...
                    >
                        <div className="space-y-8">
                            ...
                            <p className="text-forge-grey text-xl font-light italic max-w-md bg-white px-4 py-2 border-l-4 border-forge-accent">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            <a
                                ...
                                target="_blank"
                                className="flex items-center gap-8 group bg-white p-6 border border-black/5 hover:border-forge-accent/30 transition-luxury shadow-sm hover:shadow-xl"
                            >
                                <div className="w-16 h-16 bg-black text-white flex items-center justify-center shadow-lg group-hover:scale-110 transition-luxury">
                                    <Instagram size={32} />
                                </div>
                                <div>
                            ...
                            <div className="flex items-center gap-8 p-6 bg-white border border-black/5 shadow-sm">
                                <div className="w-16 h-16 bg-forge-bg text-black flex items-center justify-center shadow-lg">
                                    <Mail size={32} />
                                </div>
                                <div>
                            ...
                            <div className="flex items-center gap-8 p-6 bg-white border border-black/5 shadow-sm">
                                <div className="w-16 h-16 bg-forge-bg text-black flex items-center justify-center border border-black/5 shadow-sm">
                                    <MapPin size={32} />
                                </div>
                                <div>
                    ...
                    <motion.div
                        ...
                        className="bg-white p-10 md:p-16 border border-black/5 relative shadow-2xl"
                    >
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <input type="text" className="w-full bg-forge-bg border border-black/5 p-5 text-sm font-bold text-black focus:border-black outline-none transition-luxury shadow-sm placeholder:text-black/20" placeholder="NAME" />
                                    </div>
                                    <div className="space-y-3">
                                        <label className="text-[10px] text-black font-black uppercase tracking-[0.2em]">Email Address</label>
                                        <input type="email" className="w-full bg-forge-bg border border-black/5 p-5 text-sm font-bold text-black focus:border-black outline-none transition-luxury shadow-sm placeholder:text-black/20" placeholder="EMAIL" />
                                    </div>
                                </div>

                                <div className="space-y-3">
                                    <label className="text-[10px] text-black font-black uppercase tracking-[0.2em]">Reason for Contact</label>
                                    <select className="w-full bg-forge-bg border border-black/5 p-5 text-sm font-bold text-black/60 focus:border-black outline-none transition-luxury shadow-sm appearance-none">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea rows={6} className="w-full bg-forge-bg border border-black/5 p-5 text-sm font-bold text-black focus:border-black outline-none transition-luxury shadow-sm resize-none placeholder:text-black/20" placeholder="WHAT'S YOUR STORY?"></textarea>
                                </div>
                            </div>

                            <button className="w-full bg-black text-white py-6 flex items-center justify-center gap-4 text-xs font-black tracking-[0.4em] uppercase hover:bg-black/90 transition-luxury shadow-xl active:scale-95 group">

  ...
  return (
    <footer className="bg-white border-t border-black/5 mt-48 py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <p className="text-[10px] font-black tracking-[0.5em] text-forge-red uppercase">
                Forging a Mindset.
              </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-[11px] font-black text-black uppercase tracking-[0.4em] mb-10 border-b border-black/5 pb-4">Navigation</h3>
            <ul className="space-y-5">
              {['Shop', 'About', 'Blog', 'Contact'].map((link) => (
                <li key={link}>
                  <Link href={`/${link.toLowerCase()}`} className="text-xs font-bold text-forge-grey hover:text-forge-red tracking-widest transition-luxury uppercase">
                    {link}
                  </Link>
                </li>
              ))}
          ...
          {/* Legal & Support */}
          <div>
            <h3 className="text-[11px] font-black text-black uppercase tracking-[0.4em] mb-10 border-b border-black/5 pb-4">Engineering</h3>
            <ul className="space-y-5">
          ...
          {/* Contact & Social */}
          <div>
            <h3 className="text-[11px] font-black text-black uppercase tracking-[0.4em] mb-10 border-b border-black/5 pb-4">Connect</h3>
            <ul className="space-y-8">
              <li>
                <a
                  ...
                  className="flex items-center gap-4 text-xs font-bold text-forge-grey hover:text-forge-red transition-luxury uppercase tracking-widest"
                >
                  <Instagram size={20} className="text-forge-red" />
                  <span>Instagram</span>
                </a>
              </li>
              <li>
        ...
        {/* Bottom Bar */}
        <div className="mt-32 pt-16 border-t border-black/5 bg-forge-bone -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-12">

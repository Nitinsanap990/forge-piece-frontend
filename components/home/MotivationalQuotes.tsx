  ...
  return (
    <section className="py-24 relative overflow-hidden bg-forge-bg">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <span className="text-[10px] font-black tracking-[0.6em] text-forge-accent uppercase mb-4 block">The Forge Mentality</span>
          <h2 className="text-5xl sm:text-6xl md:text-8xl font-black mb-6 uppercase tracking-tighter text-white leading-[0.8]">
            CRAFTING <br /> THE <span className="text-forge-accent">MINDSET</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {quotes.map((quote, index) => (
            ...
            >
              <div className="relative p-12 bg-forge-card border border-white/5 hover:border-forge-accent transition-luxury shadow-sm hover:shadow-2xl hover:-translate-y-2">
                ...
                <div className="relative space-y-8">
                  ...
                  <div className="flex items-center justify-between pt-8 border-t border-white/5">
                    ...
                    <div className="px-5 py-2 bg-forge-surface text-white shadow-lg">
        ...
        >
          <div className="p-12 md:p-16 bg-forge-card border border-white/5 shadow-inner">
            <h3 className="text-2xl font-black text-white mb-6 uppercase tracking-tighter">Verbal Engineering</h3>
            <p className="text-forge-grey text-lg leading-relaxed font-light">
              ...
              <span className="text-white font-bold uppercase text-sm tracking-widest">Aura</span> to{' '}
              <span className="text-white font-bold uppercase text-sm tracking-widest">Drip</span>,

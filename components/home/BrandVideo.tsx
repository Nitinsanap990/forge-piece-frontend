    ...
    <section className="py-24 relative overflow-hidden bg-forge-bg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto mb-24">
          ...
          >
            <div className="relative aspect-video bg-white overflow-hidden border border-black/5 shadow-xl group-hover:shadow-2xl transition-luxury">
            ...
            <div className="mt-8 space-y-3">
              ...
              <p className="text-black text-base font-light leading-relaxed">A nostalgic analog journey through the early textile printing presses of Mumbai.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-8 space-y-3">
              <div className="flex items-center gap-3">
                <span className="px-3 py-1 bg-black text-white text-[9px] font-black uppercase tracking-widest">Future</span>
                <h4 className="text-black font-black uppercase text-xl tracking-tighter">Innovation Loop</h4>
              </div>
              <p className="text-black text-base font-light leading-relaxed">High-definition micro-details of 200 GSM construction and precision stitching.</p>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="relative aspect-[21/9] bg-white overflow-hidden border border-black/5 shadow-2xl flex items-center justify-center p-12 group">
            ...
            <div className="relative z-20 text-center space-y-8 max-w-3xl">
              ...
              <motion.button
                ...
                className="px-12 py-5 bg-black text-white font-black text-[10px] tracking-[0.4em] uppercase hover:bg-black/90 transition-luxury shadow-xl"
              >
